...
public class BaseRepository<T> : IBaseRepository<T> where T : class, new()
{
    ...
    public T GetSingle(Expression<Func<T, bool>> predicate) => _db.Queryable<T>().Where(predicate).First(); //����������ѯ
    public T GetById(int id) => _db.Queryable<T>().InSingle(id); //��������ѯ
    public T GetById(string id) => _db.Queryable<T>().InSingle(id); //��������ѯ
